...
build:
	...
	i386-elf-gcc -c srcs/kernel.c -o objs/kernel.o -O2 -Wall -Wextra -fno-builtin -fno-stack-protector -nostdlib -nodefaultlibs -ffreestanding
...
.PHONY: build build-ld clean fclean re
...
# Flags: -fno-builtin -fno-stack-protector -nostdlib -nodefaultlibs
