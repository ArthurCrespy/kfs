...
; IN = dl: y, dh: x ; OUT = dx: Index with offset 0xB8000 at VGA buffer
terminal_getindex:
...
; IN = dl: bg color, dh: fg color ; OUT = none
terminal_set_color:
    shl dl, 4
    or dl, dh
...
; IN = dl: y, dh: x, al: ASCII char ; OUT = none
terminal_putcharat:
    pusha
    call terminal_getindex
    mov ebx, edx
...
; IN = cx: length of string, ESI: string location ; OUT = none
terminal_write:
    pusha
.loopy:
    mov al, [esi]
